        ...
        <form @submit.prevent="enviar">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10 d-flex gap-2">
                <select v-model="entrega.id" id="tipoEntregaField" class="form-select" required>
            ...
            <div class="mb-3 row" v-for="c in criterios" :key="c.id">
              ...
              <div class="col-sm-1">
                <input type="number" :min="0" :max="10" step="any" id="notaField" class="form-control" :value="c.descricao" required>
              </div>
